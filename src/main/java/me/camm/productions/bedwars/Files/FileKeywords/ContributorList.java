...
public enum ContributorList
{
    ...
    MAJORS(new String[] {"Major Contributors: ","Buster_Buckaroo","CAMM_H87","KiwiGod888","Lercerpe","Marcaroni_","MrTeavee","Lachi_molala","XxWakiezxX"}),
    RESEARCH(new String[] {"Game Research:","adithemaddy","Buster_Buckaroo", "CAMM_H87","GR3aterG0ld", "KiwiGod888", "Lercerpe", "Marcaroni_", "MrTeavee"}),
    ...
    DATE(new String[]{"List up to date as of Jan 9 2021. Plugin development started in November 2019. Project finished in ----"});
