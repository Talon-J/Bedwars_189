...
public enum ContributorList
{
    ...
    RESEARCH(new String[] {"Game Research:","Buster_Buckaroo", "CAMM_H87","GR3aterG0ld", "KiwiGod888", "Lercerpe", "Marcaroni_", "MrTeavee","XxWakiezxX"}),
    ...
    ORIGIN(new String[] {"Message from CAMM_H87 (Developer) - \"No matter how hard something is, keep up with the persistence; you can do it. I coded the plugin on my little spare time while juggling school and social life over the course of several years. I didn't give up.\"" ,
    ...
    DATE(new String[]{"List up to date as of Oct 23 2021. Plugin development started in November 2019. Project finished in ----"});
