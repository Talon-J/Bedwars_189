...
public enum ContributorList
{
    ...
    TESTING(new String[] {"General Testing:","CAMM_H87","KiwiGod888","Lachi_molala","Marcaroni_","MrTeavee","TheBest_Fishy","Zenitsu52"}),
    MAJORS(new String[] {"Major Contributors: ","Buster_Buckaroo","CAMM_H87","KiwiGod888","Lachi_molala","Lercerpe","Marcaroni_","MrTeavee","XxWakiezxX"}),
    ...
    SPECIAL(new String[] {"Special thanks:","Buster_Buckaroo, XxWakiezxX - For a private Hypixel BedWars match.","Lachi_molala - For lending a Minecraft account to help with dedicated testing."}),
    PLAY_TEST(new String[]{"Play Testing:","CAMM_H87","TheBest_Fishy","J4CKTH3REAPER","KiwiGod888","MaidTheMage","Marcaroni_","ChristmasPotato"}),
    ...
    DATE(new String[]{"List up to date as of Feb 7th 2022. Plugin development started in November 2019. Core finished on Jan 23 2021, Release on ----"});
