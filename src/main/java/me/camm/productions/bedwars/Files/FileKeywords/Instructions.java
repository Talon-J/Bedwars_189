...
public enum Instructions
{
    ...
    ARENA(new String[]{"World: abc", "Bounds: x1,x2/y1,y2/z1,z2", "SpectatorSpawn: x/y/z", "Void: x/y/z"}),
    ...
    DATA(new String[]{"By the x1, y1, z1, etc, those are whole number values, positive or negative.",
    ...
    COMMANDS(new String[] {"Commands you'll need: /setup /register /start"});
